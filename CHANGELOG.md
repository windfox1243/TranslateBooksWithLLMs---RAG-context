...
- Added coverage for a finding dropped by locator validation and a finding too weak to repair both reaching the stored warning count, driven end to end through the reflection pass.
