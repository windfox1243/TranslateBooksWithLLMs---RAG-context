...
- Added regression coverage for canonical dialogue speaker aliases, first-person context selection, explicit relationship matches, conservative Vietnamese possessive addressing cleanup, Vietnamese second-person source-name repair, relationship-seeded Vietnamese addressing with the default `tớ/cậu` peer register, external context path preservation, compound glossary guidance, related-glossary NER hints and repair, and Save & Re-sync no-change feedback.
