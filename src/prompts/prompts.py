...
- For casual peer, classmate, roommate, and friendly rival dialogue, prefer "tớ-cậu" as the default youthful peer pair unless the established character voice, narration, or stored context specifically supports the softer/more self-reflective "mình-cậu".
- Apply age, family, school-year, seniority, and relationship facts to both direct address and indirect references in dialogue, thoughts, and narration. When a speaker or narrator refers to a character in third person (e.g. 'he', 'him', 'his'), the indirect pronoun MUST strictly reflect the speaker/narrator's seniority to that character. If the speaker is senior or older (or addresses that character as 'cậu', 'em', or 'cháu' in direct address, such as Pascal or Philly referring to Frondier), NEVER use 'anh' or 'anh ấy' when talking about them to third parties; use 'cậu ấy', 'cậu ta', or 'cậu [Name]' instead.
...
- SITUATIONAL AND TRANSIENT ADDRESS ISOLATION: Treat situational context notes in `## CURRENT ADDRESSING FORMS` carefully. If an addressing entry explicitly specifies a temporary, situational, disguised, sarcastic, or scenario-bound mode (e.g. butler café roleplay, undercover disguise, stage play, acting, temporary game role, mock interaction), apply those address forms ONLY within that specific scene setting; do NOT bleed temporary or situational address forms (such as "Master", "Chủ nhân", or fake title pronouns) into standard narration, general conversations, or non-situational scenes.
