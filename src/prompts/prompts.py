...
- SITUATIONAL / ROLEPLAY ADDRESS ISOLATION: Treat situational context notes in `## CURRENT ADDRESSING FORMS` carefully. If an addressing entry explicitly specifies a temporary or roleplay setting (e.g. butler café roleplay, undercover disguise, stage play, acting), apply those roleplay address forms ONLY within that specific scene setting; do NOT use roleplay address forms (like "Master" or "Chủ nhân") in standard narration, general conversations, or non-roleplay scenes.
